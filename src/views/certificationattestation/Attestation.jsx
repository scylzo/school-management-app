...
import {
  fetchStudents,
  fetchStudentsWithAdminValid,
} from "redux/studentFeatures";
...
export const Attestation = () => {
  ...
  useEffect(() => {
    ...
    if (!isCancelled) {
      dispatch(fetchStudentsWithAdminValid());
  ...
  const handleRedirectToAttestation = () => {
    navigate(`attestation/${studentId}`);
  };
        ...
        customBodyRender: (value, tableMeta, updateValue) => {
          return (
            <Box>
              ...
              >
                <Box>
                  {studentObject?.admission.map((item, index) => {
                    return (
                      <Button
                        key={index}
                        style={{
                        ...
                        onClick={() => {
                          handleRedirectToAttestation();
                          localStorage.setItem("admissionId", item?.id);
                          localStorage.setItem("CycleAttestation", item?.Cycle);
                        }}
                      >
                        {item?.Cycle}
                      </Button>
