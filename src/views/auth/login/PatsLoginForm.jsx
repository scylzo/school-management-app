...
import { loginPats } from "redux/authFeatures";
...
const PatsLoginForm = ({ marginTop }) => {
  const dispatch = useDispatch();
  const [showHide, setShowHide] = useState(true);
  useEffect(() => {
    let isCancelled = false;
    if (!isCancelled) {
      localStorage.setItem("tab", "Pats");
    }
    return () => {
      isCancelled = true;
    };
