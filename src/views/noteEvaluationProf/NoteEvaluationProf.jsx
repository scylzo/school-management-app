...
export const NoteEvaluationProf = () => {
  ...
  const niveauEtude = user?.Niveau_etude || [];
  ...
  const dislayGrades = () => {
    if (semestreData) {
      navigate(`classe/${transformedName}`);
    } else {
    ...
    <div className="div-container">
      ...
      <div className="content-wrapper">
        <div className="main-container" style={{ width: "100%" }}>
          <Topbar
            currentViewTitle="USSD > Administration > Notes & Évaluations"
